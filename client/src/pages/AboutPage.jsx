...
function AboutPage () {
  return (
    <MainContainer page='about-page'>
      <HeroWrapper imgUrl='src/assets/home-hero.jpg'>
        <div className="about">
          <h4>Did you know...</h4>
          <div>
